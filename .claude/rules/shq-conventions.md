...
- `doc/shq/solutions/` — lessons learned (generated by `/ce:compound`)
...
|------|------|----------------|
| Doc templates | `shq-doc-templates.md` | ADR, PRD, Superpowers plans, and lessons learned formats |
...
| GitHub safety | `shq-github-safety.md` | Never interact with upstream repo, PR target verification |
| Deployment | `shq-deployment.md` | Docker Compose overrides, deploy scripts, BATS testing patterns |
